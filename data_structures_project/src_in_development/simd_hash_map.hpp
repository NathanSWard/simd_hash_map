...
template<typename Key,
         ...
         std::size_t InitNumGroups = 0
> class simd_hash_base : private Hash, private KeyEqual
{
public:
  using key_type = Key;
  using mapped_type = T;
...
> class simd_hash_map : public simd_hash_base<Key, T, Hash, KeyEqual, simd_metadata::size>
{
}; 

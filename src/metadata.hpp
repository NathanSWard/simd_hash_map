...
static inline bool isSentry(const metadata md)         {return md == md_states::mdSentry;}
static inline bool isEmptyOrDeleted(const metadata md) {return md < md_states::mdSentry;}
